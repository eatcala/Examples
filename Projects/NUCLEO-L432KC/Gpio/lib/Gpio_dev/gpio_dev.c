...
void GpioDev_Init(void)
{
    ...
    // ******************* Analog measurement *******************
    // ************* services creation *******************
    pin[P1] = Luos_CreateService(rx_digit_read_cb, STATE_MOD, "digit_read_P1", revision);
    pin[P7] = Luos_CreateService(rx_digit_read_cb, STATE_MOD, "digit_read_P7", revision);
    pin[P8] = Luos_CreateService(rx_digit_read_cb, STATE_MOD, "digit_read_P8", revision);
    pin[P9] = Luos_CreateService(rx_digit_read_cb, STATE_MOD, "digit_read_P9", revision);
