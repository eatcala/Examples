 ...
 * Variables
 ******************************************************************************/
profile_core_t stepper_motor_profile;
...
void Stepper_Init(void)
{
    ...
    // ************** Service creation *****************
    Luos_LinkServoMotorProfile(&stepper_motor_profile, &stepper_motor, Stepper_MsgHandler);
    Luos_LaunchProfile(&stepper_motor_profile, "stepper_motor", revision);
}
/******************************************************************************
