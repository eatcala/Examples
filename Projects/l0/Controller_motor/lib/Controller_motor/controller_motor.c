...
profile_core_t servo_motor_handler;
...
void ControllerMotor_Init(void)
{
    ...
    */
    ...
    // ************** Service creation *****************
    Luos_LinkServoMotorProfile(&servo_motor_handler, &servo_motor, 0);
    Luos_LaunchProfile(&servo_motor_handler, "servo_motor", revision);
}
/******************************************************************************
