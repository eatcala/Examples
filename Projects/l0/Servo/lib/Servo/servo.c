...
void Servo_Init(void)
{
    ...
    service_serv[0] = Luos_CreateService(Servo_MsgHandler, SERVO_MOD, "servo1_mod", revision);
    service_serv[1] = Luos_CreateService(Servo_MsgHandler, SERVO_MOD, "servo2_mod", revision);
    service_serv[2] = Luos_CreateService(Servo_MsgHandler, SERVO_MOD, "servo3_mod", revision);
    service_serv[3] = Luos_CreateService(Servo_MsgHandler, SERVO_MOD, "servo4_mod", revision);
    servo_parameters_t param;
