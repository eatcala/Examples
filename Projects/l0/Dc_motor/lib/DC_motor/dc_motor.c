...
void MotorDC_Init(void)
{
    ...
    service[0] = Luos_CreateService(MotorDC_MsgHandler, DCMOTOR_MOD, "DC_motor1_mod", revision);
    service[1] = Luos_CreateService(MotorDC_MsgHandler, DCMOTOR_MOD, "DC_motor2_mod", revision);
}
/******************************************************************************
